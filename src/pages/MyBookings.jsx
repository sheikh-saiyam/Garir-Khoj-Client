        ...
        {myBookings.length === 0 ? (
          ...
          <>
                  ...
                  <table className="table">
                    ...
                    <thead>
                      <tr>
                        ...
                        <th className="text-md font-bold text-center dark:text-white">
                          Booking Status
                        </th>
                        <th className="text-md font-bold dark:text-white">
                          Actions
            ...
            <div className="pt-20 pb-10">
              <div>
                <h1 className="mb-6 flex items-center gap-1 justify-center font-bold text-2xl md:text-3xl dark:text-white lg:text-4xl text-center font-serif">
                  <FaRegChartBar className="text-accent dark:text-white" />
                  Cars Daily Rental{" "}
                  <Typewriter
                    words={["Price Chart"]}
                    loop={false}
