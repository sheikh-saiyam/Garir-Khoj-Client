  ...
  return (
    <div className="pb-20">
      <div className="text-center">
        ...
        <p className="mt-6 font-medium mx-auto text-[#393939] text-lg max-w-3xl">
          ...
          >
            <div>
              <img
                ...
                alt=""
              />
              <button className="btn w-1/2 absolute bottom-0 left-1/2 transform -translate-x-1/2 translate-y-1/2 mt-4 hover:scale-105 transition-transform backdrop-blur-sm bg-transparent border-2 border-b-gray-300 border-white/40 rounded-lg text-[#2e2d2d] font-bold tracking-wider text-lg hover:!bg-transparent">
                {offer.buttonText}
              </button>
            </div>
          </div>
